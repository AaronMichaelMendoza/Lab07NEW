...
HD_PWD='C:/Users/ammic/OneDrive/Documents/GitHub/Lab07NEW/Lab07_projectnew/Lab07_projectnew.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sseg1_bcd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sseg1_bcd_wrapper.tcl -notrace
